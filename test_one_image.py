...
if __name__ == '__main__':
    ...
    # train_dirname = '../dataset_100_rgb_ycbcr_lbp/trainset/RGB/'
    #test_dirname = '../dataset_100_rgb_ycbcr_lbp/testset/RGB'
    ...
    transform= transforms.Compose([transforms.Resize((256,256), interpolation=Image.ANTIALIAS),transforms.ToTensor(),transforms.Normalize((0.6964, 0.6828, 0.6776), (0.2685, 0.2723, 0.2711))])
    ...
    with torch.no_grad():
        ...
        with torch.no_grad():    
            ...
            for i in range(1,80):
                x = Image.open('./shoes_sneaker/%04d.png'%i).convert('RGB')
                x = x.resize((256,256))
                x= transform(x)
